...
**Mac:** скачайте `MuseDesk-1.23.0-macOS-AppleSilicon.dmg`, перенесите приложение в Applications и пройдите встроенную настройку Glimmer. На Mac сканируются собственные параметры устройства, а не профиль NVIDIA из Windows. [Подробная инструкция для Apple Silicon](docs/MACOS.md).
