# Концепция и границы установщика Windows

Здесь описан отдельный Windows EXE. В релизах также доступны [macOS DMG/ZIP](MACOS.md) и [Ubuntu DEB](UBUNTU.md) со встроенным мастером настройки модели. Общая политика компонентов: [COMPONENTS.md](COMPONENTS.md).
